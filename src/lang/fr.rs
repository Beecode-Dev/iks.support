...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau iksSupport..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à iksSupport."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à iksSupport l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser iksSupport à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [iksSupport Input]."),
        ...
        ("Quit", "Quitter"),
        ("doc_mac_permission", "https://iksSupport.com/docs/fr/manual/mac/#enable-permissions"),
        ("Help", "Aider"),
        ("Failed", "échouer"),
        ("Succeeded", "Succès"),
        ...
        ("Language", "Langue"),
        ("Keep iksSupport background service", "Gardez le service iksSupport en arrière plan"),
        ...
        ("Show iksSupport", "Afficher iksSupport"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à iksSupport l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à iksSupport les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de iksSupport en cours d'éxécution."),
        ...
        ("install_cert_tip", "Installer le certificat iksSupport"),
        ("confirm_install_cert_tip", "Il s'agit d'un certificat iksSupport, auquel on peut faire confiance. Le certificat sera utilisé pour approuver et installer les pilotes iksSupport si nécessaire."),
        ...
        ("verify_iksSupport_password_tip", "Vérifier le mot de passe iksSupport"),
