...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használata során. A megfelelő működés érdekében, kérem telepítse a iksSupport alkalmazást a számítógépre."),
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A távoli vezérléshez a iksSupport-nek \"Kisegítő lehetőség\" engedélyre van szüksége"),
        ...
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [iksSupport Input] szolgáltatást."),
        ...
        ("Quit", "Kilépés"),
        ("doc_mac_permission", "https://iksSupport.com/docs/hu/manual/mac/#enable-permissions"),
        ("Help", "Segítség"),
        ("Failed", "Sikertelen"),
        ("Succeeded", "Sikeres"),
        ...
        ("Language", "Nyelv"),
        ("Keep iksSupport background service", "iksSupport futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívűl hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a iksSupport alkalmazás beállítási oldalára, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ("Start on Boot", ""),
        ...
        ("Show iksSupport", "A iksSupport megjelenítése"),
