...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі iksSupport..."),
        ...
        ("install_tip", "Через UAC в деяких випадках iksSupport може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення iksSupport в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати iksSupport дозволи \"Доступності\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці,вам необхідно надати iksSupport дозволи на \"Запис екрану\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити iksSupport використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [iksSupport Input]."),
        ...
        ("Language", "Мова"),
        ("Keep iksSupport background service", "Зберегти фонову службу iksSupport"),
        ...
        ("Show iksSupport", "Показати iksSupport"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати iksSupport дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати iksSupport дозвіл на \"Запис аудіо\""),
        ...
        ("install_cert_tip", "Додати сертифікат iksSupport"),
        ("confirm_install_cert_tip", "Це сертифікат тестування iksSupport, якому можна довіряти. За потреби сертифікат буде використано для погодження та встановлення драйверів iksSupport."),
        ...
        ("verify_iksSupport_password_tip", "Перевірте пароль iksSupport"),
