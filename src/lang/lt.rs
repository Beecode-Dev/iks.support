...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie iksSupport tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti iksSupport netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte iksSupport į savo kompiuterį."),
        ...
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti iksSupport \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti iksSupport leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad iksSupport startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti iksSupport naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"iksSupport įvestis\" paslaugą."),
        ...
        ("Quit", "Išeiti"),
        ("doc_mac_permission", "https://iksSupport.com/docs/en/manual/mac/"),
        ("Help", "Pagalba"),
        ("Failed", "Nepavyko"),
        ("Succeeded", "Pavyko"),
        ...
        ("Language", "Kalba"),
        ("Keep iksSupport background service", "Palikti iksSupport fonine paslauga"),
        ...
        ("Show iksSupport", "Rodyti iksSupport"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti iksSupport leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti iksSupport leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant iksSupport UAC lange paspaustų \"OK\"."),
        ...
        ("verify_iksSupport_password_tip", "Įveskite kliento iksSupport slaptažodį"),
