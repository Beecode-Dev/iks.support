...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar iksSupport tīklu..."),
        ...
        ("install_tip", "UAC dēļ iksSupport dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu iksSupport sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Click to download", "Lejupielādēt"),
        ("Click to update", "Atjaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir iksSupport \"Accessibility\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir iksSupport \"Screen Recording\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj iksSupport izmantot servisu \"Accessibility\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un ievadiet [Installed Services], ieslēdziet servisu [iksSupport Input]."),
        ...
        ("doc_fix_wayland", "https://iksSupport.com/docs/en/manual/linux/#x11-required"),
        ("Help", "Palīdzība"),
        ("Failed", "Neizdevās"),
        ("Succeeded", "Izdevās"),
        ...
        ("Language", "Valoda"),
        ("Keep iksSupport background service", "Saglabāt iksSupport fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo iksSupport lietojumprogrammas iestatījumu lapu, atrodiet un ievadiet [Battery], noņemiet atzīmi no [Unrestricted]"),
        ...
        ("Show iksSupport", "Rādīt iksSupport"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir iksSupport \"Input Monitoring\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir iksSupport \"Record Audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas iksSupport."),
        ...
        ("install_cert_tip", "Instalēt iksSupport sertifikātu"),
        ("confirm_install_cert_tip", "Šis ir iksSupport testēšanas sertifikāts, kuram var uzticēties. Sertifikāts tiks izmantots, lai uzticētos un vajadzības gadījumā instalētu iksSupport draiverus."),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot iksSupport, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_iksSupport_server_pro_to_{}_tip", "Lūdzu, jauniniet iksSupport Server Pro uz versiju {} vai jaunāku!"),
    ].iter().cloned().collect();
}
