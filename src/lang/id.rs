...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan iksSupport..."),
        ...
        ("install_tip", "Karena UAC, iksSupport tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal iksSupport ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" iksSupport."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" iksSupport."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan iksSupport untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input iksSupport]."),
        ...
        ("Language", "Bahasa"),
        ("Keep iksSupport background service", "Pertahankan iksSupport berjalan pada service background"),
        ...
        ("Show iksSupport", "Tampilkan iksSupport"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada iksSupport"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada iksSupport"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC iksSupport yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat iksSupport"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian iksSupport, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver iksSupport saat diperlukan"),
        ...
        ("verify_iksSupport_password_tip", "Verifikasi Kata Sandi iksSupport"),
        ...
        ("scam_text1", "Jika Anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan iksSupport, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_iksSupport_server_pro_to_{}_tip", "Silahkan perbarui iksSupport Server Pro ke versi {} atau yang lebih baru!"),
    ].iter().cloned().collect();
}
