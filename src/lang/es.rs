...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red iksSupport en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que iksSupport no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar iksSupport a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Click to download", "Clic para descargar"),
        ("Click to update", "Clic para refrescar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a iksSupport de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a iksSupport de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que iksSupport use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [iksSupport Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep iksSupport background service", "Dejar iksSupport como Servicio en 2do plano"),
        ...
        ("Show iksSupport", "Mostrar iksSupport"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a iksSupport permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a iksSupport permisos de \"Grabar Audio\"."),
        ...
        ("verify_iksSupport_password_tip", "Verificar la contraseña de iksSupport"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses iksSupport e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_iksSupport_server_pro_to_{}_tip", "¡Por favor, actualiza iksSupport Server Pro a la versión {} o superior"),
    ].iter().cloned().collect();
}
