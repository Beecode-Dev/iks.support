...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "iksSupport może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować iksSupport w swoim systemie."),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić iksSupport na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [iksSupport Input]."),
        ...
        ("Language", "Język"),
        ("Keep iksSupport background service", "Zachowaj usługę iksSupport w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji iksSupport, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show iksSupport", "Pokaż iksSupport"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji iksSupport uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("install_cert_tip", "Instalacja certyfikatu iksSupport"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy iksSupport, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników iksSupport w razie potrzeby."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z iksSupport w Twojej sieci."),
        ...
        ("verify_iksSupport_password_tip", "Weryfikuj hasło iksSupport"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu iksSupport i uruchomienia usługi - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_iksSupport_server_pro_to_{}_tip", "Proszę zaktualizować iksSupport Server Pro do wersji {} lub nowszej!"),
    ].iter().cloned().collect();
}
