...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Mit dieser ID und diesem Passwort kann der Supporter auf Ihren Desktop zugegriffen werden."),
        ("Password", "Passwort"),
        ("Ready", "Bereit"),
        ("Established", "Verbunden"),
        ("connecting_status", "Verbinden mit dem iks-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann iksSupport in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren iksSupport auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie iksSupport Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie iksSupport die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie iksSupport erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"iksSupport Input\" ein."),
        ...
        ("Quit", "Beenden"),
        ("doc_mac_permission", "https://iksSupport.com/docs/de/manual/mac/#berechtigungen-aktivieren"),
        ("Help", "Hilfe"),
        ...
        ("Language", "Sprache"),
        ("Keep iksSupport background service", "iksSupport im Hintergrund ausführen"),
        ...
        ("Show iksSupport", "iksSupport anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie iksSupport die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie iksSupport die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von iksSupport auf \"Ja\" klicken."),
        ...
        ("install_cert_tip", "iksSupport-Zertifikat installieren"),
        ("confirm_install_cert_tip", "Dies ist ein iksSupport-Testzertifikat, dem vertraut werden kann. Das Zertifikat wird verwendet, um iksSupport-Treibern bei Bedarf zu vertrauen und diese zu installieren."),
        ...
        ("verify_iksSupport_password_tip", "iksSupport-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, iksSupport zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_iksSupport_server_pro_to_{}_tip", "Bitte aktualisieren Sie iksSupport Server Pro auf die Version {} oder neuer!"),
    ].iter().cloned().collect();
}
