...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem iksSupport..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, iksSupport v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate iksSupportu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate iksSupportu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno iksSupportu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »iksSupport Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep iksSupport background service", "Ohrani iksSupportovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije iksSupport, poiščite »Baterija« in izklopite »Neomejeno«"),
        ("Start on Boot", ""),
        ...
        ("Show iksSupport", "Prikaži iksSupport"),
