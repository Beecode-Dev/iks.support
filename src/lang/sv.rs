...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till iksSupport..."),
        ...
        ("install_tip", "På grund av UAC, kan inte iksSupport fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera iksSupport på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge iksSupport \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge iksSupport \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [iksSupport Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep iksSupport background service", "Behåll iksSupport i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa iksSupport programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on Boot", ""),
        ...
        ("Show iksSupport", "Visa iksSupport"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
