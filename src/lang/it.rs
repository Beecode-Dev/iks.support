...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete iksSupport..."),
        ...
        ("install_tip", "A causa del controllo account uUtente (UAC), iksSupport potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare iksSupport a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a iksSupport il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a iksSupport il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a iksSupport di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [iksSupport Input]."),
        ...
        ("Quit", "Esci"),
        ("doc_mac_permission", "https://iksSupport.com/docs/en/manual/mac/#enable-permissions"),
        ("Help", "Aiuto"),
        ("Failed", "Fallito"),
        ...
        ("Language", "Lingua"),
        ("Keep iksSupport background service", "Mantieni il servizio di iksSupport in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione iksSupport, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show iksSupport", "Visualizza iksSupport"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a iksSupport 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione a iksSupport 'Registra audio'."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto faccia clic su OK nella finestra UAC dell'esecuzione di iksSupport."),
        ...
        ("install_cert_tip", "Installa certificato iksSupport"),
        ("confirm_install_cert_tip", "Questo è un certificato di test iksSupport, che può essere considerato attendibile.\nIl certificato verrà usato per certificarsi ed installare i driver iksSupport quando richiesto."),
        ...
        ("verify_iksSupport_password_tip", "Conferma password iksSupport"),
        ...
        ("Exit", "Esci da iksSupport"),
        ("Open", "Apri iksSupport"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare iksSupport e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_iksSupport_server_pro_to_{}_tip", "Aggiorna iksSupport Server Pro alla versione {} o successiva!"),
    ].iter().cloned().collect();
}
