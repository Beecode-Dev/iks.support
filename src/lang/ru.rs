...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети iksSupport..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC iksSupport может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже для установки iksSupport в системе."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить iksSupport права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить iksSupport права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить iksSupport использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"iksSupport Input\"."),
        ...
        ("Quit", "Выйти"),
        ("doc_mac_permission", "https://iksSupport.com/docs/ru/manual/mac/#включение-разрешений"),
        ("Help", "Помощь"),
        ("Failed", "Не выполнено"),
        ("Succeeded", "Выполнено"),
        ...
        ("Language", "Язык"),
        ("Keep iksSupport background service", "Держать в фоне службу iksSupport"),
        ...
        ("Show iksSupport", "Показать iksSupport"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить iksSupport разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить iksSupport разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске iksSupport."),
        ...
        ("install_cert_tip", "Установить сертификат iksSupport"),
        ("confirm_install_cert_tip", "Это тестовый сертификат iksSupport, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов iksSupport."),
        ...
        ("verify_iksSupport_password_tip", "Подтвердить пароль iksSupport"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать iksSupport и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_iksSupport_server_pro_to_{}_tip", "Обновите iksSupport Server Pro до версии {} или новее!"),
    ].iter().cloned().collect();
}
