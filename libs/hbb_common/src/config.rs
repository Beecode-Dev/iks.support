...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("iksSupport".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["iks.support"];

pub const RS_PUB_KEY: &str = match option_env!("RS_PUB_KEY") {
    Some(key) if !key.is_empty() => key,
    _ => "V2AZa8ULoZ48xyU3Cbq5g1hXrR7mtAgkaF+WihyAZWU=",
};
